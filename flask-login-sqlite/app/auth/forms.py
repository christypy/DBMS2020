...
class RegistrationForm(Form):
    ...
    s_id=StringField('學號',validators=[DataRequired(message="不能為空"), Regexp('[0-9]{9}$', message='請輸入學號，九位數字')	,sid_exists])
    name = StringField('姓名', validators=[DataRequired(message="不能為空"), Length(1,15, message='1-15字')])
...
class ReturnForm(Form):
    uid=IntegerField('雨傘編號',validators=[DataRequired(message="不能為空"),uid_exists])
